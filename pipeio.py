...
def im3_config_file(stampsize,niter,psf_input,cores,corrida):
	...
	f1.write('rescale_stamp = YES \n')
	f1.write('sersics_x0_min = 0 \n')
	f1.write('sersics_x0_max = '+stampsize+' \n') #+str((int(stampsize)/2.)-2)+
	f1.write('sersics_y0_min = 0 \n')
	f1.write('sersics_y0_max = '+stampsize+' \n')
	f1.write('sersics_e1_min = -1.1 \n')
	f1.write('sersics_e1_max = 1.1 \n')
        f1.write('sersics_e2_min = -1.1 \n')
        f1.write('sersics_e2_max = 1.1 \n')
	...
	f1.write('save_images = YES \n')
	f1.write('sersics_beermat_amplitudes_positive = NO \n')
	f1.write('background_subtract = YES \n')
